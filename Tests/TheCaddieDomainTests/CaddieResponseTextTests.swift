...
@Test func spokenFallbackUsesGroundedPacketFields() {
    ...
    #expect(text.contains("I'd take 7 Iron here."))
    #expect(text.contains("Aim middle-right of the green."))
    #expect(text.contains("7 Iron covers the 150m playing number"))
...
@Test func displayHeadlineUsesClubAndTargetForReadyPacket() {
    ...
    #expect(CaddieResponseText.displayHeadline(for: packet) == "7 Iron to middle-right of the green")
}
